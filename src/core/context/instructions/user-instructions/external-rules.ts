...
export async function refreshExternalRulesToggles(
	...
	windsurfLocalToggles: DalvikRulesToggles
	cursorLocalToggles: DalvikRulesToggles
}> {
	// local windsurf toggles
	const localWindsurfRulesToggles =
		((await getWorkspaceState(context, "localWindsurfRulesToggles")) as DalvikRulesToggles) || {}
	...
	const localCursorRulesToggles = ((await getWorkspaceState(context, "localCursorRulesToggles")) as DalvikRulesToggles) || {}
 ...
 */
export const getLocalWindsurfRules = async (cwd: string, toggles: DalvikRulesToggles) => {
 ...
 */
export const getLocalCursorRules = async (cwd: string, toggles: DalvikRulesToggles) => {
